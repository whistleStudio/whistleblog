  ...
  <div class="essay flex-center">
    <div>
      ...
      <div class="main">
        ...
        <div class="content" v-else-if="showMode===0">
...
let isCateExp = ref<boolean>(false), showMode = ref<number>(1), essayList = ref<IEssay[]>([]), actEssay = ref<IEssay>(), actCate = ref<string>(articleCate[0]),
